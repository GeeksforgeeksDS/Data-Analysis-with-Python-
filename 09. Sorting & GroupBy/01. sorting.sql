...
select * from gfg.products order by discounted_price desc;

# 2. Finding the least expensive product on myntra
select * from gfg.products order by discounted_price asc;

# 3. Finding the top 5 most expensive product on myntra
select * from gfg.products order by discounted_price desc limit 5;
